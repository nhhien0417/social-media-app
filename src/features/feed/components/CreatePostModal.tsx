...
type PrivacyOption = 'public' | 'friends' | 'only-me'
...
export const CreatePostModal: React.FC<CreatePostModalProps> = ({
  ...
  const modalBackground = isDark ? '#18191a' : '#ffffff'
  ...
  const renderPrivacyModal = () => {
    const PrivacyIcon =
      privacyOptions.find(opt => opt.value === privacy)?.icon || Globe
                ...
                return (
                  ...
                  >
                    <XStack
                      ...
                      borderRadius={8}
                      backgroundColor={
                        isSelected ? inputBackground : 'transparent'
                      }
                      alignItems="center"
                      gap="$3"
                    >
  ...
  const PrivacyIcon =
    privacyOptions.find(opt => opt.value === privacy)?.icon || Globe
  const privacyLabel =
    privacyOptions.find(opt => opt.value === privacy)?.label || 'Friends'
                  ...
                  {groupName ? (
                    ...
                    <Pressable onPress={() => setShowPrivacyModal(true)}>
                      <XStack
                        ...
                        alignSelf="flex-start"
                      >
                        <PrivacyIcon size={12} color={textColor} />
                        <Text fontSize={12} fontWeight="600" color={textColor}>
                          {privacyLabel}
                        </Text>
